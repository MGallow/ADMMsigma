...
microbenchmark(ADMMsigma(S = S, lam = 0.1, tol1 = 1e-4, tol2 = 1e-4))

# benchmark ADMMsigma - tolerance 1e-8
microbenchmark(ADMMsigma(S = S, lam = 0.1, tol1 = 1e-8, tol2 = 1e-8))

# benchmark ADMMsigma CV - likelihood convergence criteria
microbenchmark(ADMMsigma(X, crit = "lik"))

# benchmark ADMMsigma CV
microbenchmark(ADMMsigma(X, lam = 10^seq(-8, 8, 0.1), alpha = seq(0, 1, 0.1)))
